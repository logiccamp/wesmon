                                ...
                                <div class="tab-pane fade show active" id="mmenu" role="tabpanel" aria-labelledby="mmenu-tab">
                                    <nav class="slideable-menu">
                                        <ul>
                                            ...
                                            <li class="<?php echo e(request()->routeIs('front.campaign')  ? 'active' : ''); ?>"><a href="<?php echo e(route('front.campaign')); ?>"><i class="icon-chevron-right"></i><?php echo e(__('Offers')); ?></a></li>
                                            <?php endif; ?>
                    ...
                    <div class="nav-inner">
                        <nav class="site-menu">
                            <ul>
                                ...
                                <?php endif; ?>
                                <?php if($setting->is_campaign == 1): ?>
                                <li class="<?php echo e(request()->routeIs('front.campaign')  ? 'active' : ''); ?>"><a href="<?php echo e(route('front.campaign')); ?>"><?php echo e(__('Offers')); ?></a></li>
                                <?php endif; ?>
                                <?php if($setting->is_brands == 1): ?>
...
<?php /**PATH C:\lara\www\emmerce\core\resources\views/master/front.blade.php ENDPATH**/ ?>